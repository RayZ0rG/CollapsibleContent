 ...
 */
 ...
 add_action( 'init', __NAMESPACE__ . '\register_custom_faq_post_type' );
 /**
  ...
  * @return void
  */
 function register_custom_faq_post_type() {
  ...
  /**
 * Get all the post type labels configuration.
 *
 * @since 1.0.0
 *
